...
import com.nathanielbennett.tweeter.server.service.FollowersServiceImpl;

public class GetFollowersHandler implements RequestHandler<FollowRequest, FollowResponse> {
